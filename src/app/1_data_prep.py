...
# OUTPUT_FOLDER = "data/pepperstone_tick-data"

# ## >> Real Account <<
# """
# SYMBOLS = ["SPY.US.a", "US500.a"] 
# OUTPUT_FOLDER = "data/pepperstone_tick-data_real"
# """
...
# print(f"\n--- Analysis (Diff) ---")
# print(f"1. Timestamps unique to only-rep (Excess)(Data loss):  {len(only_in_final_dup):,}")
...
# print("\n\n")
# final_df.to_csv(os.path.join(base_path, f"{filename}.csv"), index=True)
# print(f"🔍 Saved Inspection Data: \"../../data/{filename}.csv\"")

# final_df.to_parquet(os.path.join(base_path, f"{filename}.parquet"), compression="snappy")
# print(f"✅ Saved Master Data: \"../../data/{filename}.parquet\"")
